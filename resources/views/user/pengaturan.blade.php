...
@section('contents')
    ...
    <div class="mt-3">
        ...
        <form action="{{ route('usersetting') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-row">
                <div class="col-md-3 form-group">
                    <div class="form-group">
                        <img class="img-thumbnail" src="{{ asset('/img/ava/avatar-02-512.webp') }}" width="200" height="200"
                            id="preview" alt="">
